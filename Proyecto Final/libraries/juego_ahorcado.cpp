// librerias para la aplicacion del juego del ahorcado
...
void pausar_programa1() // funcion para pausar el programa
{
...
void fun_juego_ahorcado() // Funcion principal
{
    ...
    while (finPrograma) // Ciclo infinito para el menu
    {
        ...
        switch (modo) // Estructura switch para seleccionar la opcion del menu 
        {
            case 1: // Caso 1: Jugar contra la computadora
            {
                ...
                pausar_programa1(); // Llamamos a la funcion para pausar el programa
                system("cls"); // Limpiamos la consola
