// librerias para la aplicacion del juego de las torres de hanoi
...
void pausar_programa2() // funcion para pausar el programa
{
...
void fun_juego_torres_hanoi() // Funcion principal del programa
{
    ...
    while (ejecucion) // Mientras la variable ejecucion sea verdadera
    {
        ...
        switch (opcion) // Estructura switch para controlar la opcion seleccionada por el usuario
        {
            case 1: // Si el usuario selecciona la opcion 1
            {
                ...
                pausar_programa2(); // Llamamos a la funcion para pausar el programa
                system("cls"); // Limpiamos la consola
